...
const frontPageBannerAd = document.getElementById('masthead-ad');
...
//banner ad
var frontPageBannerAd = document.getElementById('dismissible');
if (frontPageBannerAd) {
    frontPageBannerAd.parentNode.removeChild(frontPageBannerAd);
  console.log('Banner ad removed');
} else {
...
//search sponsors
var searchAds = document.querySelectorAll('div#rendering-content.style-scope.ytd-in-feed-ad-layout-renderer');
